...
bot_token = "446738577:AAHu8ZPDnhjbOJK4BegQY_9te74ywXlDnwk" --Put You Token Here
...
function create_config( )
	...
	if server_user:match("^inline$") then
		BeyondTeam = '/inline/BDReborn'
	elseif not server_user:match("^inline$") then
  ...
  config = {
    ...
    sudo_users = {435978472,374734484},--Sudo users
    admins = {},
    disabled_channels = {},
    moderation = {data = '/home/inline/robots/BDReborn/data/moderation.json'},
    info_text = [[ Fiery Helper v 1.5
]],
  }
